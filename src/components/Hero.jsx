      ...
      >
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            Liberte o poder dos agentes de IA! Potencialize sua produtividade com a K-Sec, a plataforma de agentes inteligentes que revoluciona seu trabalho.
          </p>
          <Button onClick={handleScrollTo} white>
            Começar
          </Button>
        </div>
